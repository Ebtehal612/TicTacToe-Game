...
class GameViewModel : ViewModel() {
    ...
    private fun gameReset() {
        ...
        state = state.copy(
            ...
            currentTurn = BoardCellValue.CIRICLE,
    ...
    private fun addValueToBoard(cellNo: Int) {
        ...
        if (state.currentTurn == BoardCellValue.CIRICLE) {
            boardItems[cellNo] = BoardCellValue.CIRICLE
            if (checkForVictory(BoardCellValue.CIRICLE)) {
                state=state.copy(
